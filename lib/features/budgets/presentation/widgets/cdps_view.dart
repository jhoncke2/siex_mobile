...
class CdpsView extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    final blocState = BlocProvider.of<BudgetsBloc>(context).state as OnCdps;
            ...
            children: [
              InkWell(
                onTap: blocState is OnOldCdps? (){
                  BlocProvider.of<BudgetsBloc>(context).add(ChangeCdpsTypeEvent(CdpsType.newType));
                } : null,
                child: Container(
              ...
              InkWell(
                onTap: blocState is OnNewCdps? (){
                  BlocProvider.of<BudgetsBloc>(context).add(ChangeCdpsTypeEvent(CdpsType.oldType));
                } : null,
                child: Container(
                  width: screenWidth * 0.5,
                  padding: EdgeInsets.symmetric(
