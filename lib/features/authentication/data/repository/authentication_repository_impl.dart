...
class AuthenticationRepositoryImpl implements AuthenticationRepository{
  ...
  Future<Either<AuthenticationFailure, void>> login(User user)async{
    return await _manageFunctionExceptions<void>(()async{
      ...
      final pushNotificationsToken = await localDataSource.getPushNotificationsToken();
      await remoteDataSource.setUserPushNotificationsToken(accessToken, pushNotificationsToken);
